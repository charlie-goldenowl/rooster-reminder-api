...
export class InitialMigration1758101986539 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_21ca897cc5bae77a77d8968a06" ON "users" ("birthday", "timezone") `);
        await queryRunner.query(`CREATE TYPE "public"."event_logs_event_type_enum" AS ENUM('birthday', 'anniversary')`);
        await queryRunner.query(`CREATE TYPE "public"."event_logs_status_enum" AS ENUM('pending', 'sent', 'failed', 'retry')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_82fa50d0394f4d90b42dfc050b" ON "event_logs" ("status", "created_at") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_4d7831f8a50253c0c7e59f82f0" ON "event_logs" ("user_id", "event_type", "event_year") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_4d7831f8a50253c0c7e59f82f0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_82fa50d0394f4d90b42dfc050b"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_21ca897cc5bae77a77d8968a06"`);
